...
class Game_Battler
  ...
  #--------------------------------------------------------------------------
  def initialize
    @UK_name = "GamBatt1TODO"
    @UK_class_name = "GamBatt1TODO"
    @battler_name = ""
    @battler_hue = 0
    @hp = 0
    @sp = 0
...
=end
  ...
  def UK_name
    ...
    namu = @name
    return namu.translation_check #for unique Succubi
  end
  def UK_class_name
    return $data_classes[@class_id].UK_name
  end
